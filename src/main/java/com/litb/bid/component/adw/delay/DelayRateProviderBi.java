...
public class DelayRateProviderBi implements DelayRateProviderInterface {
  ...
  // constructor
  public DelayRateProviderBi(SiteType siteType) throws SQLException, IOException  {
...
//          String key = getKey(channel, lang, parentCid, week);
  ...
  public static void main(String[] args) throws Exception {
    if (args.length >= 1 && args[0].equals("load")) {
      DelayRateProviderBi.loadBiData(SiteType.litb);
      DelayRateProviderBi.loadBiData(SiteType.mini);
    } else {
      System.out.println("Use parameter 'load' to load data from BI.");
    }
    System.out.println("Done");
    System.exit(0);
//    DelayRateProviderBi delayRateProviderBi = new DelayRateProviderBi(SiteType.litb);
//    System.out.println(delayRateProviderBi.getDelayRate(LitbAdChannel.adwords_search, SiteType.litb, LanguageType.en, 71, 1, 7, 90));
  }
}
