...
public class RedirectSuccRateProvider implements RedirectSuccRateProviderInterface {
	private static final double DEFAULT_RATE = 0.95;
	
	private HashMap<String, Double> keyRateMap = new HashMap<String, Double>();
	
	public RedirectSuccRateProvider() {
...
//			return new RedirectSuccRateInfo(siteType, null, -1, DEFAULT_RATE);
		return new RedirectSuccRateInfo(siteType, null, -1, 1.0);
	}
...
//				}
//				String siteTypeString = st.nextToken();
//				SiteType siteType = SiteType.valueOf(siteTypeString);
//				if (siteType != SiteType.litb && siteType != SiteType.mini) {
//					throw new Exception("siteType != litb & siteType != mini");
//				}
...
//				}
//				double rate = provider.getRediretPaymentRate(siteType, languageType);
//				System.out.println("redirect payment rate : " + rate);
//			} catch (Exception e) {
//				System.err.println("usage: <siteType> <languageType>");
//				e.printStackTrace();
//			}
//		}
	} 
