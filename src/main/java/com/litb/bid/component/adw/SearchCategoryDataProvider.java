...
public class SearchCategoryDataProvider implements SearchCategoryDataProviderInterface {
	...
	public SearchCategoryDataProvider(SiteType siteType, Date endDate) throws IOException, SQLException {
		String categoryPath = DirDef.getLocalBiddableObjectCategoryGroupFilePath(siteType, AdwordsChannel.search, endDate);
	...
	@Override
      ...
      for(int categoryId : cidList){
          ...
          if(aggregation == null)
              continue;
          DeviceStatItem deviceStatItem = aggregation.getStatItems()[Conf.getIntervalIndex(Conf.INTERVAL_365_DAYS)];
	...
	public static void main(String[] args) throws IOException, SQLException {
		...
		SearchCategoryDataProvider searchCategoryDataProvider = new SearchCategoryDataProvider(SiteType.litb, endDate);
