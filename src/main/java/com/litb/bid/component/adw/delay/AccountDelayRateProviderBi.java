...
public class AccountDelayRateProviderBi{
  ...
  // constructor
  public AccountDelayRateProviderBi(SiteType siteType) throws SQLException, IOException  {
...
//static methods
 ...
 private static String getOrderNumArrayFilePath(SiteType siteType) {
  ...
  // static methods
  private static String getKey(LitbAdChannel channel, long campaignId, int categoryId) {
    return channel + "_" + campaignId + "_" + categoryId;
  }
  // public methods
  public DelayRateInfo getDelayRate(LitbAdChannel channel, SiteType siteType, long campaignId, int categoryId,
  ...
  public static void main(String[] args) throws Exception {
	if (args.length >= 1 && args[0].equals("load")) {
		AccountDelayRateProviderBi.loadBiData(SiteType.litb);
	  AccountDelayRateProviderBi.loadBiData(SiteType.mini);
    } else {
      System.out.println("Use parameter 'load' to load data from BI.");
    }
	AccountDelayRateProviderBi delayRateProviderBi = new AccountDelayRateProviderBi(SiteType.litb);
    System.out.println(delayRateProviderBi.getDelayRate(LitbAdChannel.adwords_search, SiteType.litb, -1L, 1180, 1, 1, 30));
