...
import com.litb.bid.component.adw.AvgCpcAgainstMaxCpcRatioProviderInterface;
...
import com.litb.bid.process.GapCpcComputer;
...
public class AvgCpcAgainstMaxCpcRatioPcHistoryProvider implements
	...
	// constructor
	public AvgCpcAgainstMaxCpcRatioPcHistoryProvider(Date endDate, AdwordsChannel channel){
		try {
