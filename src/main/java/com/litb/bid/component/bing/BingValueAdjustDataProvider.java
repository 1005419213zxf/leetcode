...
public class BingValueAdjustDataProvider implements BingValueAdjustDataProviderInterface {
...
//
    ...
    public BingValueAdjustDataProvider(SiteType siteType) throws SQLException {
    ...
    public BingValueAdjustRateInfo getValueAdjustRate(LanguageType languageType, int cid) {
        ...
        BingValueAdjustRateInfo onlinePayRatioInfo = getData(keyOnlinePayRatioMap, languageType, cid, pcidList, "onlinePayRatioInfo");
        if(onlinePayRatioInfo == null)
            return null;
        BingValueAdjustRateInfo onlineConfirmDivideReceivedInfo = getData(keyOnlineConfirmDivideReceivedMap, languageType, cid, pcidList, "onlineConfirmDivideReceivedInfo");
        if(onlineConfirmDivideReceivedInfo == null)
            return null;
        BingValueAdjustRateInfo offlineConfirmRateInfo = getData(keyOfflineConfirmRateMap, languageType, cid, pcidList, "offlineConfirmRateInfo");
        if(offlineConfirmRateInfo == null)
            return null;
        BingValueAdjustRateInfo valueAdjInfo = getData(keyValueAdjMap, languageType, cid, pcidList, "valueAdjInfo");
    ...
    private BingValueAdjustRateInfo getData(Map<String, Double> map, LanguageType languageType, int cid, List<Integer> pcidList, String alert){
...
//        BingValueAdjustDataProvider litbProvider = new BingValueAdjustDataProvider(SiteType.litb);
